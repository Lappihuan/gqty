...
export interface VueClientDefaults {
  /**
...
export function createVueClient<
  GeneratedSchema extends {
    query: object;
    mutation: object;
    subscription: object;
...
>(
  ...
  optsCreate: CreateVueClientOptions = {}
): VueClient<GeneratedSchema> {
  ...
  const defaults: VueClientOptionsWithDefaults['defaults'] = {
  ...
  const opts: VueClientOptionsWithDefaults = Object.assign({}, optsCreate, {
    defaults,
  });
